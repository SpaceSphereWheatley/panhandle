...
// `aud` against this same value. Still registered to shopping.mohibb.com in
// Google Cloud Console (project panhandle-502411) — re-registering the
// authorized origin to shop.panhandle.app (now the app's live domain) is a
// pending manual dashboard step, see docs/android-publishing.md step 7.
