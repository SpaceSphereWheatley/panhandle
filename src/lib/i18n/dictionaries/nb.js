...
export const nb = {
  ...
  "shoppingList.confirm.markAllBought.body": "Merke alle varer på listen som handlet?",
  "shoppingList.confirm.markAllBought.title": "Merk alle som handlet?",
  "shoppingList.confirm.markAllBought.confirmLabel": "Merk alle",
  ...
  "shoppingList.fab.markAllBought": "Merk alle som handlet",
  ...
  "storage.emptyTitle": "Ingen treff",
  ...
  "storage.edit.numberManualLabel": "Boksnummer (valgfritt)",
  "storage.edit.numberManualPlaceholder": "La stå tomt for automatisk nummer",
  "storage.edit.invalidNumber": "Boksnummer må være et positivt heltall",
  "storage.edit.nameLabel": "Navn",
  "storage.edit.namePlaceholder": "f.eks. Julepynt",
  "storage.edit.locationLabel": "Sted",
  "storage.edit.locationPlaceholder": "f.eks. Garasje, Loft hylle 2",
  "storage.edit.itemsLabel": "Innhold",
  "storage.edit.itemsPlaceholder": "Legg til en gjenstand…",
  "storage.edit.notesLabel": "Notater (valgfritt)",
  "storage.edit.notesPlaceholder": "f.eks. skjør, eller nøyaktig hvilken hylle",
  "storage.edit.requiredFields": "Navn og sted må fylles ut",
  "storage.edit.deleteBox": "Slett boks",
  "storage.edit.confirmDelete.title": "Slette boks?",
  "storage.edit.confirmDelete.body": 'Slette «{name}»? Dette kan ikke angres.',
  ...
  "storage.labels.tabExisting": "Eksisterende bokser",
  "storage.labels.tabNew": "Nye koder",
  "storage.labels.selectAll": "Velg alle",
  "storage.labels.selectNone": "Velg ingen",
  "storage.labels.selectedCount": "{count} valgt",
  "storage.labels.reserveCountLabel": "Hvor mange nye koder?",
  "storage.labels.reserveButton": "Reserver og skriv ut",
  "storage.labels.reserveFailed": "Kunne ikke reservere nye koder – sjekk tilkoblingen",
  "storage.labels.reservedSummary": "Reservert #{from}–#{to}. Sett én på hver tomme boks, og skann den senere for å fylle inn innholdet.",
  "storage.labels.reserveNewBatch": "Reserver et annet antall",
  "storage.labels.outstandingTitle": "Ubrukte koder fra tidligere",
  "storage.labels.outstandingDescription": "Reservert, men aldri gitt en boks. Skriv dem ut på nytt i stedet for å reservere flere, eller forkast dem der arket er borte for godt.",
  "storage.labels.reprintSelected": "Skriv ut valgte på nytt",
  "storage.labels.discard": "Forkast",
  "storage.labels.discardFailed": "Kunne ikke forkaste koden – sjekk tilkoblingen",
  ...
  "settings.household.members.invite.label": "Inviter et medlem",
  "settings.household.members.invite.explain": "Lag en lenke og send den til den du vil legge til – de oppretter sin egen konto når de åpner den.",
  "settings.household.members.invite.generate": "Lag invitasjonslenke",
  "settings.household.members.invite.regenerate": "Lag ny lenke",
  "settings.household.members.invite.active": "Invitasjonslenke aktiv",
  "settings.household.members.invite.expiresOn": "Utløper {date}",
  "settings.household.members.invite.revoke": "Opphev",
  "settings.household.members.invite.confirmRevoke.title": "Oppheve invitasjonslenken?",
  "settings.household.members.invite.confirmRevoke.body": "Alle med den nåværende lenken vil ikke lenger kunne bruke den for å bli med.",
  "settings.household.members.invite.confirmRevoke.confirmLabel": "Opphev",
  "settings.household.members.invite.confirmRegenerate.title": "Lage en ny lenke?",
  "settings.household.members.invite.confirmRegenerate.body": "Den nåværende invitasjonslenken slutter å virke så snart du lager en ny.",
  "settings.household.members.invite.confirmRegenerate.confirmLabel": "Lag ny lenke",
  "settings.household.members.invite.linkModalTitle": "Invitasjonslenke opprettet",
  "settings.household.members.invite.linkModalNote": "Del denne lenken med den du vil invitere. Den utløper om 7 dager og kan bare brukes én gang.",
  "settings.household.members.invite.copyLink": "Kopier lenke",
  "settings.household.members.invite.copied": "Lenke kopiert",
  "settings.household.members.invite.copyFailed": "Kunne ikke kopiere – merk og kopier lenken manuelt",
  ...
  "auth.invite.loading": "Laster invitasjon...",
  "auth.invite.title": "Du er invitert til å bli med i {name} sin husstand",
  "auth.invite.titleFallback": "Du er invitert til å bli med i en husstand",
  "auth.invite.subtitle": "Opprett en konto for å bli med og begynne å dele handleliste og måltidsplan.",
  "auth.invite.invalidTitle": "Denne invitasjonslenken er ikke gyldig",
  "auth.invite.invalidBody": "Den kan ha utløpt eller allerede blitt brukt. Be eieren av husstanden sende deg en ny.",
  "auth.invite.backToLogin": "Gå til innlogging i stedet",
  "auth.invite.submit": "Bli med i husstanden",
  "auth.invite.busy": "Blir med...",
  "auth.invite.failed": "Kunne ikke bli med i husstanden",
