...
export const nb = {
  ...
  "storage.previewBanner": "Personlig forhåndsvisning — kun synlig for deg. Ingenting lagres ennå.",
  "storage.searchPlaceholder": "Søk i bokser og gjenstander…",
  "storage.itemCount": { one: "{count} gjenstand", other: "{count} gjenstander" },
  "storage.addBox": "Legg til boks",
  "storage.addBoxToast": "Kommer snart — dette er bare en forhåndsvisning",
