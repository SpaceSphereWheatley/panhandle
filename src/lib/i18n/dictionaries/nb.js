...
export const nb = {
  ...
  "meals.recipeUrlLabel": "Oppskriftslenke (valgfritt)",
  "meals.recipeUrlPlaceholder": "https://…",
  "meals.openRecipe": "Åpne",
  "meals.day.aria.openRecipe": "Åpne oppskriften for {meal}",
  ...
  "meals.edit.importToggle": "Legg til oppskriftslenke",
  ...
  "meals.edit.recipeUrlHint": "Lagres sammen med måltidet, så den følger med hver gang du planlegger det. «Importer» fyller også inn navn og ingredienser fra siden.",
  ...
  "storage.labels.tabNew": "Ny sekvens",
  "storage.labels.selectAll": "Velg alle",
  "storage.labels.selectNone": "Velg ingen",
  "storage.labels.selectedCount": "{count} valgt",
  "storage.labels.startNumber": "Startnummer",
  "storage.labels.endNumber": "Sluttnummer",
  "storage.labels.count": "Antall",
