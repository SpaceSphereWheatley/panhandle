...
(function (global) {
  ...
  function iconSvg(name) {
    ...
    return '<svg viewBox="0 0 100 100" class="item-icon" aria-hidden="true">' + G(I[key]) + '</svg>';
  }

  global.ITEM_ICON_LIB = I;
  global.ITEM_ICON_MAP = MAP;
  global.iconKeyForItem = iconKey;
  global.iconSvgForItem = iconSvg;
  // Back-compat name used by index.html grid.
  global.iconForItem = iconSvg;
