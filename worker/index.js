...
export const COMMON_ITEMS = [
  { name: "Frukt", category: "Fruit and vegetables" },
  { name: "Grønnsaker", category: "Fruit and vegetables" },
  { name: "Banan", category: "Fruit and vegetables" },
  { name: "Eple", category: "Fruit and vegetables" },
  { name: "Appelsin", category: "Fruit and vegetables" },
  { name: "Sitron", category: "Fruit and vegetables" },
  { name: "Druer", category: "Fruit and vegetables" },
  { name: "Jordbær", category: "Fruit and vegetables" },
  { name: "Blåbær", category: "Fruit and vegetables" },
  { name: "Avokado", category: "Fruit and vegetables" },
  { name: "Tomat", category: "Fruit and vegetables" },
  { name: "Agurk", category: "Fruit and vegetables" },
  { name: "Salat", category: "Fruit and vegetables" },
  { name: "Brokkoli", category: "Fruit and vegetables" },
  { name: "Gulrot", category: "Fruit and vegetables" },
  { name: "Potet", category: "Fruit and vegetables" },
  { name: "Løk", category: "Fruit and vegetables" },
  { name: "Hvitløk", category: "Fruit and vegetables" },
  { name: "Paprika", category: "Fruit and vegetables" },
  { name: "Sopp", category: "Fruit and vegetables" },
  { name: "Spinat", category: "Fruit and vegetables" },
  { name: "Ingefær", category: "Fruit and vegetables" },
  { name: "Brød", category: "Bread and bakery" },
  { name: "Grovbrød", category: "Bread and bakery" },
  { name: "Loff", category: "Bread and bakery" },
  { name: "Rundstykker", category: "Bread and bakery" },
  { name: "Knekkebrød", category: "Bread and bakery" },
  { name: "Tortilla", category: "Bread and bakery" },
  { name: "Boller", category: "Bread and bakery" },
  { name: "Melk", category: "Dairy" },
  { name: "Lettmelk", category: "Dairy" },
  ...
  { name: "Kjøtt", category: "Meat and fish" },
  { name: "Fisk", category: "Meat and fish" },
  { name: "Pålegg", category: "Meat and fish" },
  { name: "Kjøttdeig", category: "Meat and fish" },
  { name: "Kylling", category: "Meat and fish" },
  { name: "Kyllingfilet", category: "Meat and fish" },
  { name: "Bacon", category: "Meat and fish" },
  { name: "Pølser", category: "Meat and fish" },
  { name: "Kjøttboller", category: "Meat and fish" },
  { name: "Laks", category: "Meat and fish" },
  { name: "Torsk", category: "Meat and fish" },
  { name: "Tunfisk", category: "Meat and fish" },
  { name: "Reker", category: "Meat and fish" },
  { name: "Fiskekaker", category: "Meat and fish" },
  { name: "Kokt skinke", category: "Meat and fish" },
  { name: "Mel", category: "Ingredients and spices" },
  { name: "Olje", category: "Ingredients and spices" },
  { name: "Salt", category: "Ingredients and spices" },
  { name: "Pepper", category: "Ingredients and spices" },
  { name: "Sukker", category: "Ingredients and spices" },
  { name: "Hvetemel", category: "Ingredients and spices" },
  { name: "Olivenolje", category: "Ingredients and spices" },
  { name: "Soyasaus", category: "Ingredients and spices" },
  { name: "Ketchup", category: "Ingredients and spices" },
  { name: "Sennep", category: "Ingredients and spices" },
  { name: "Majones", category: "Ingredients and spices" },
  { name: "Tomatpuré", category: "Ingredients and spices" },
  { name: "Hermetiske tomater", category: "Ingredients and spices" },
  { name: "Honning", category: "Ingredients and spices" },
  { name: "Grandiosa", category: "Frozen and ready meals" },
  { name: "Frosne grønnsaker", category: "Frozen and ready meals" },
  { name: "Frosne bær", category: "Frozen and ready meals" },
  { name: "Pommes frites", category: "Frozen and ready meals" },
  { name: "Iskrem boks", category: "Frozen and ready meals" },
  { name: "Frokostblanding", category: "Grains and pasta" },
  { name: "Havregryn", category: "Grains and pasta" },
  { name: "Müsli", category: "Grains and pasta" },
  { name: "Cornflakes", category: "Grains and pasta" },
  { name: "Ris", category: "Grains and pasta" },
  { name: "Pasta", category: "Grains and pasta" },
  { name: "Spaghetti", category: "Grains and pasta" },
  { name: "Makaroni", category: "Grains and pasta" },
  { name: "Couscous", category: "Grains and pasta" },
  { name: "Kikerter", category: "Grains and pasta" },
  { name: "Potetgull", category: "Snacks and sweets" },
  { name: "Melkesjokolade", category: "Snacks and sweets" },
  { name: "Kjeks", category: "Snacks and sweets" },
  { name: "Popcorn", category: "Snacks and sweets" },
  { name: "Sjokolade", category: "Snacks and sweets" },
  { name: "Vann", category: "Drinks" },
  { name: "Kullsyret vann", category: "Drinks" },
  { name: "Cola", category: "Drinks" },
  { name: "Juice", category: "Drinks" },
  { name: "Saft", category: "Drinks" },
  ...
  { name: "Tørkepapir", category: "Household" },
  { name: "Kjøkkenrull", category: "Household" },
  { name: "Oppvasksåpe", category: "Household" },
  { name: "Oppvaskmaskin tabletter", category: "Household" },
  { name: "Vaskemiddel", category: "Household" },
  { name: "Allrengjøring", category: "Household" },
  { name: "Søppelsekker", category: "Household" },
  { name: "Aluminiumsfolie", category: "Household" },
  { name: "Bakepapir", category: "Household" },
  { name: "Tannkrem", category: "Health and personal care" },
  { name: "Tannbørste", category: "Health and personal care" },
  { name: "Sjampo", category: "Health and personal care" },
  { name: "Dusjsåpe", category: "Health and personal care" },
  { name: "Håndsåpe", category: "Health and personal care" },
  { name: "Plaster", category: "Health and personal care" },
  { name: "Kattemat", category: "Pet supplies" },
  { name: "Hundemat", category: "Pet supplies" },
  { name: "Blomster", category: "Other" },
  { name: "Pære", category: "Fruit and vegetables" },
  { name: "Klementin", category: "Fruit and vegetables" },
  { name: "Mandarin", category: "Fruit and vegetables" },
  { name: "Lime", category: "Fruit and vegetables" },
  { name: "Grapefrukt", category: "Fruit and vegetables" },
  { name: "Bringebær", category: "Fruit and vegetables" },
  { name: "Bjørnebær", category: "Fruit and vegetables" },
  { name: "Kiwi", category: "Fruit and vegetables" },
  { name: "Mango", category: "Fruit and vegetables" },
  { name: "Ananas", category: "Fruit and vegetables" },
  { name: "Melon", category: "Fruit and vegetables" },
  { name: "Vannmelon", category: "Fruit and vegetables" },
  { name: "Fersken", category: "Fruit and vegetables" },
  { name: "Nektarin", category: "Fruit and vegetables" },
  { name: "Plomme", category: "Fruit and vegetables" },
  { name: "Aprikos", category: "Fruit and vegetables" },
  { name: "Granateple", category: "Fruit and vegetables" },
  { name: "Cherrytomat", category: "Fruit and vegetables" },
  { name: "Isbergsalat", category: "Fruit and vegetables" },
  { name: "Ruccola", category: "Fruit and vegetables" },
  { name: "Grønnkål", category: "Fruit and vegetables" },
  { name: "Blomkål", category: "Fruit and vegetables" },
  { name: "Søtpotet", category: "Fruit and vegetables" },
  { name: "Rødløk", category: "Fruit and vegetables" },
  { name: "Purreløk", category: "Fruit and vegetables" },
  { name: "Vårløk", category: "Fruit and vegetables" },
  { name: "Chili", category: "Fruit and vegetables" },
  { name: "Squash", category: "Fruit and vegetables" },
  { name: "Aubergine", category: "Fruit and vegetables" },
  { name: "Mais", category: "Fruit and vegetables" },
  { name: "Sukkererter", category: "Fruit and vegetables" },
  { name: "Champignon", category: "Fruit and vegetables" },
  { name: "Reddik", category: "Fruit and vegetables" },
  { name: "Rødbete", category: "Fruit and vegetables" },
  { name: "Kålrot", category: "Fruit and vegetables" },
  { name: "Stangselleri", category: "Fruit and vegetables" },
  { name: "Asparges", category: "Fruit and vegetables" },
  { name: "Rosenkål", category: "Fruit and vegetables" },
  { name: "Hodekål", category: "Fruit and vegetables" },
  { name: "Rødkål", category: "Fruit and vegetables" },
  { name: "Kinakål", category: "Fruit and vegetables" },
  { name: "Persille", category: "Fruit and vegetables" },
  { name: "Basilikum", category: "Fruit and vegetables" },
  { name: "Koriander", category: "Fruit and vegetables" },
  { name: "Dill", category: "Fruit and vegetables" },
  { name: "Gressløk", category: "Fruit and vegetables" },
  { name: "Mynte", category: "Fruit and vegetables" },
  { name: "Rabarbra", category: "Fruit and vegetables" },
  { name: "Pasjonsfrukt", category: "Fruit and vegetables" },
  { name: "Kokosnøtt", category: "Fruit and vegetables" },
  { name: "Erter", category: "Fruit and vegetables" },
  { name: "Baguette", category: "Bread and bakery" },
  { name: "Polarbrød", category: "Bread and bakery" },
  { name: "Pita", category: "Bread and bakery" },
  { name: "Lefse", category: "Bread and bakery" },
  { name: "Vafler", category: "Bread and bakery" },
  { name: "Pannekaker", category: "Bread and bakery" },
  { name: "Croissant", category: "Bread and bakery" },
  { name: "Skolebrød", category: "Bread and bakery" },
  { name: "Kanelboller", category: "Bread and bakery" },
  { name: "Muffins", category: "Bread and bakery" },
  { name: "Kake", category: "Bread and bakery" },
  { name: "Sjokoladekake", category: "Bread and bakery" },
  { name: "Brioche", category: "Bread and bakery" },
  { name: "Toastbrød", category: "Bread and bakery" },
  { name: "Fullkornsbrød", category: "Bread and bakery" },
  { name: "Speltbrød", category: "Bread and bakery" },
  { name: "Surdeigsbrød", category: "Bread and bakery" },
  { name: "Ciabatta", category: "Bread and bakery" },
  { name: "Focaccia", category: "Bread and bakery" },
  { name: "Naanbrød", category: "Bread and bakery" },
  { name: "Hamburgerbrød", category: "Bread and bakery" },
  { name: "Hotdogbrød", category: "Bread and bakery" },
  { name: "Kavring", category: "Bread and bakery" },
  { name: "Donut", category: "Bread and bakery" },
  { name: "Helmelk", category: "Dairy" },
  { name: "Skummet melk", category: "Dairy" },
  { name: "Ekstra lettmelk", category: "Dairy" },
  { name: "Laktosefri melk", category: "Dairy" },
  { name: "Kremfløte", category: "Dairy" },
  { name: "Matfløte", category: "Dairy" },
  { name: "Crème fraîche", category: "Dairy" },
  { name: "Lettrømme", category: "Dairy" },
  { name: "Margarin", category: "Dairy" },
  { name: "Bremykt", category: "Dairy" },
  { name: "Jarlsberg", category: "Dairy" },
  { name: "Gulost", category: "Dairy" },
  { name: "Cottage cheese", category: "Dairy" },
  { name: "Kremost", category: "Dairy" },
  { name: "Philadelphia", category: "Dairy" },
  { name: "Fetaost", category: "Dairy" },
  { name: "Cheddar", category: "Dairy" },
  { name: "Naturell yoghurt", category: "Dairy" },
  { name: "Drikkeyoghurt", category: "Dairy" },
  { name: "Kefir", category: "Dairy" },
  { name: "Kvarg", category: "Dairy" },
  { name: "Vaniljesaus", category: "Dairy" },
  { name: "Iskrem", category: "Dairy" },
  { name: "Karbonadedeig", category: "Meat and fish" },
  { name: "Svinekjøtt", category: "Meat and fish" },
  { name: "Storfekjøtt", category: "Meat and fish" },
  { name: "Kyllinglår", category: "Meat and fish" },
  { name: "Kyllingvinger", category: "Meat and fish" },
  { name: "Kalkun", category: "Meat and fish" },
  { name: "Biff", category: "Meat and fish" },
  { name: "Entrecôte", category: "Meat and fish" },
  { name: "Indrefilet", category: "Meat and fish" },
  { name: "Ytrefilet", category: "Meat and fish" },
  { name: "Svinekoteletter", category: "Meat and fish" },
  { name: "Svinefilet", category: "Meat and fish" },
  { name: "Grillpølser", category: "Meat and fish" },
  { name: "Wienerpølser", category: "Meat and fish" },
  { name: "Medisterkaker", category: "Meat and fish" },
  { name: "Lammekjøtt", category: "Meat and fish" },
  { name: "Lammelår", category: "Meat and fish" },
  { name: "Pinnekjøtt", category: "Meat and fish" },
  { name: "Ribbe", category: "Meat and fish" },
  { name: "Spekeskinke", category: "Meat and fish" },
  { name: "Salami", category: "Meat and fish" },
  { name: "Servelat", category: "Meat and fish" },
  { name: "Leverpostei", category: "Meat and fish" },
  { name: "Røkt laks", category: "Meat and fish" },
  { name: "Ørret", category: "Meat and fish" },
  { name: "Sei", category: "Meat and fish" },
  { name: "Hyse", category: "Meat and fish" },
  { name: "Makrell", category: "Meat and fish" },
  { name: "Sild", category: "Meat and fish" },
  { name: "Fiskeboller", category: "Meat and fish" },
  { name: "Fiskepinner", category: "Meat and fish" },
  { name: "Fiskegrateng", category: "Meat and fish" },
  { name: "Krabbe", category: "Meat and fish" },
  { name: "Blåskjell", category: "Meat and fish" },
  { name: "Scampi", category: "Meat and fish" },
  { name: "Brunt sukker", category: "Ingredients and spices" },
  { name: "Melis", category: "Ingredients and spices" },
  { name: "Vaniljesukker", category: "Ingredients and spices" },
  { name: "Sammalt mel", category: "Ingredients and spices" },
  { name: "Maizena", category: "Ingredients and spices" },
  { name: "Bakepulver", category: "Ingredients and spices" },
  { name: "Natron", category: "Ingredients and spices" },
  { name: "Gjær", category: "Ingredients and spices" },
  { name: "Tørrgjær", category: "Ingredients and spices" },
  { name: "Rapsolje", category: "Ingredients and spices" },
  { name: "Solsikkeolje", category: "Ingredients and spices" },
  { name: "Eddik", category: "Ingredients and spices" },
  { name: "Balsamico", category: "Ingredients and spices" },
  { name: "Remulade", category: "Ingredients and spices" },
  { name: "Buljong", category: "Ingredients and spices" },
  { name: "Buljongterning", category: "Ingredients and spices" },
  { name: "Grønnsaksbuljong", category: "Ingredients and spices" },
  { name: "Kokosmelk", category: "Ingredients and spices" },
  { name: "Sirup", category: "Ingredients and spices" },
  { name: "Peanøttsmør", category: "Ingredients and spices" },
  { name: "Nugatti", category: "Ingredients and spices" },
  { name: "Jordbærsyltetøy", category: "Ingredients and spices" },
  { name: "Bringebærsyltetøy", category: "Ingredients and spices" },
  { name: "Marmelade", category: "Ingredients and spices" },
  { name: "Karri", category: "Ingredients and spices" },
  { name: "Paprikakrydder", category: "Ingredients and spices" },
  { name: "Chilipulver", category: "Ingredients and spices" },
  { name: "Kanel", category: "Ingredients and spices" },
  { name: "Kardemomme", category: "Ingredients and spices" },
  { name: "Muskat", category: "Ingredients and spices" },
  { name: "Gurkemeie", category: "Ingredients and spices" },
  { name: "Spisskummen", category: "Ingredients and spices" },
  { name: "Oregano", category: "Ingredients and spices" },
  { name: "Timian", category: "Ingredients and spices" },
  { name: "Rosmarin", category: "Ingredients and spices" },
  { name: "Laurbærblad", category: "Ingredients and spices" },
  { name: "Hvitløkspulver", category: "Ingredients and spices" },
  { name: "Tacokrydder", category: "Ingredients and spices" },
  { name: "Grillkrydder", category: "Ingredients and spices" },
  { name: "Bakekakao", category: "Ingredients and spices" },
  { name: "Sjokoladebiter", category: "Ingredients and spices" },
  { name: "Gelatin", category: "Ingredients and spices" },
  { name: "Vaniljeessens", category: "Ingredients and spices" },
  { name: "Mandler", category: "Ingredients and spices" },
  { name: "Valnøtter", category: "Ingredients and spices" },
  { name: "Hasselnøtter", category: "Ingredients and spices" },
  { name: "Cashewnøtter", category: "Ingredients and spices" },
  { name: "Pinjekjerner", category: "Ingredients and spices" },
  { name: "Rosiner", category: "Ingredients and spices" },
  { name: "Sesamfrø", category: "Ingredients and spices" },
  { name: "Solsikkefrø", category: "Ingredients and spices" },
  { name: "Gresskarkjerner", category: "Ingredients and spices" },
  { name: "Fond", category: "Ingredients and spices" },
  { name: "Frossenpizza", category: "Frozen and ready meals" },
  { name: "Lasagne", category: "Frozen and ready meals" },
  { name: "Frosne erter", category: "Frozen and ready meals" },
  { name: "Potetbåter", category: "Frozen and ready meals" },
  { name: "Løkringer", category: "Frozen and ready meals" },
  { name: "Frossen fisk", category: "Frozen and ready meals" },
  { name: "Vårruller", category: "Frozen and ready meals" },
  { name: "Wok grønnsaker", category: "Frozen and ready meals" },
  { name: "Frosne kjøttboller", category: "Frozen and ready meals" },
  { name: "Ferdigmiddag", category: "Frozen and ready meals" },
  { name: "Pai", category: "Frozen and ready meals" },
  { name: "Saftis", category: "Frozen and ready meals" },
  { name: "Frossen kylling", category: "Frozen and ready meals" },
  { name: "Pizzasnurrer", category: "Frozen and ready meals" },
  { name: "Pannekaker frosne", category: "Frozen and ready meals" },
  { name: "Frossen laks", category: "Frozen and ready meals" },
  { name: "Frosne reker", category: "Frozen and ready meals" },
  { name: "Potetlomper", category: "Frozen and ready meals" },
  { name: "Smoothie frosne bær", category: "Frozen and ready meals" },
  { name: "Fiskepinner frosne", category: "Frozen and ready meals" },
  { name: "Frossen pizza mini", category: "Frozen and ready meals" },
  { name: "Pølsedeig", category: "Frozen and ready meals" },
  { name: "Lettkokte havregryn", category: "Grains and pasta" },
  { name: "Frosties", category: "Grains and pasta" },
  { name: "Cheerios", category: "Grains and pasta" },
  { name: "Havrefras", category: "Grains and pasta" },
  { name: "Weetabix", category: "Grains and pasta" },
  { name: "Puffet ris", category: "Grains and pasta" },
  { name: "Jasminris", category: "Grains and pasta" },
  { name: "Basmatiris", category: "Grains and pasta" },
  { name: "Risgrøt", category: "Grains and pasta" },
  { name: "Grøtris", category: "Grains and pasta" },
  { name: "Penne", category: "Grains and pasta" },
  { name: "Fusilli", category: "Grains and pasta" },
  { name: "Lasagneplater", category: "Grains and pasta" },
  { name: "Tagliatelle", category: "Grains and pasta" },
  { name: "Bulgur", category: "Grains and pasta" },
  { name: "Quinoa", category: "Grains and pasta" },
  { name: "Byggryn", category: "Grains and pasta" },
  { name: "Røde linser", category: "Grains and pasta" },
  { name: "Sorte bønner", category: "Grains and pasta" },
  { name: "Kidneybønner", category: "Grains and pasta" },
  { name: "Polenta", category: "Grains and pasta" },
  { name: "Pannekakemix", category: "Grains and pasta" },
  { name: "Vaffelmix", category: "Grains and pasta" },
  { name: "Linser", category: "Grains and pasta" },
  { name: "Ostepop", category: "Snacks and sweets" },
  { name: "Saltstenger", category: "Snacks and sweets" },
  { name: "Nachos", category: "Snacks and sweets" },
  { name: "Dipp", category: "Snacks and sweets" },
  { name: "Salsa", category: "Snacks and sweets" },
  { name: "Guacamole", category: "Snacks and sweets" },
  { name: "Mørk sjokolade", category: "Snacks and sweets" },
  ...
  { name: "Seigmenn", category: "Snacks and sweets" },
  { name: "Vingummi", category: "Snacks and sweets" },
  { name: "Lakris", category: "Snacks and sweets" },
  { name: "Pastiller", category: "Snacks and sweets" },
  { name: "Tyggegummi", category: "Snacks and sweets" },
  { name: "Digestive", category: "Snacks and sweets" },
  { name: "Marie kjeks", category: "Snacks and sweets" },
  { name: "Havrekjeks", category: "Snacks and sweets" },
  { name: "Sjokoladekjeks", category: "Snacks and sweets" },
  ...
  { name: "Saltlakris", category: "Snacks and sweets" },
  { name: "Chips", category: "Snacks and sweets" },
  { name: "Mineralvann", category: "Drinks" },
  { name: "Cola Zero", category: "Drinks" },
  ...
  { name: "Multijuice", category: "Drinks" },
  { name: "Solbærsaft", category: "Drinks" },
  { name: "Eplemost", category: "Drinks" },
  { name: "Iste", category: "Drinks" },
  { name: "Filterkaffe", category: "Drinks" },
  { name: "Kaffekapsler", category: "Drinks" },
  { name: "Espresso", category: "Drinks" },
  { name: "Grønn te", category: "Drinks" },
  { name: "Svart te", category: "Drinks" },
  { name: "Urtete", category: "Drinks" },
  { name: "Kakaopulver", category: "Drinks" },
  { name: "Energidrikk", category: "Drinks" },
  { name: "Red Bull", category: "Drinks" },
  { name: "Smoothie", category: "Drinks" },
  { name: "Øl", category: "Drinks" },
  { name: "Vin", category: "Drinks" },
  { name: "Servietter", category: "Household" },
  { name: "Oppvaskmaskinsalt", category: "Household" },
  { name: "Tøymykner", category: "Household" },
  { name: "Flekkfjerner", category: "Household" },
  { name: "Klorin", category: "Household" },
  { name: "Glassrengjøring", category: "Household" },
  { name: "Toalettrens", category: "Household" },
  { name: "Baderengjøring", category: "Household" },
  { name: "Skurepulver", category: "Household" },
  { name: "Oppvaskbørste", category: "Household" },
  { name: "Oppvasksvamp", category: "Household" },
  { name: "Kluter", category: "Household" },
  { name: "Mikrofiberklut", category: "Household" },
  { name: "Søppelposer", category: "Household" },
  { name: "Fryseposer", category: "Household" },
  { name: "Matpapir", category: "Household" },
  { name: "Plastfolie", category: "Household" },
  { name: "Lyspære", category: "Household" },
  { name: "Batterier", category: "Household" },
  { name: "Stearinlys", category: "Household" },
  { name: "Telys", category: "Household" },
  { name: "Fyrstikker", category: "Household" },
  { name: "Gulvmopp", category: "Household" },
  { name: "Luftfrisker", category: "Household" },
  { name: "Vaskepulver", category: "Household" },
  { name: "Skyllemiddel", category: "Household" },
  { name: "Grønnsåpe", category: "Household" },
  { name: "Tannpirker", category: "Household" },
  { name: "Tape", category: "Household" },
  { name: "Klesklyper", category: "Household" },
  { name: "Zip poser", category: "Household" },
  { name: "Håndsåpe kjøkken", category: "Household" },
  { name: "Støvkluter", category: "Household" },
  { name: "Vaskeklut", category: "Household" },
  { name: "Bleier", category: "Health and personal care" },
  { name: "Bleier størrelse 4", category: "Health and personal care" },
  { name: "Bleier størrelse 5", category: "Health and personal care" },
  { name: "Våtservietter", category: "Health and personal care" },
  { name: "Barnemat", category: "Health and personal care" },
  { name: "Barnegrøt", category: "Health and personal care" },
  { name: "Velling", category: "Health and personal care" },
  { name: "Morsmelkerstatning", category: "Health and personal care" },
  { name: "Smokk", category: "Health and personal care" },
  { name: "Tåteflaske", category: "Health and personal care" },
  { name: "Bæsjposer", category: "Health and personal care" },
  { name: "Babyolje", category: "Health and personal care" },
  { name: "Babykrem", category: "Health and personal care" },
  { name: "Vaselin", category: "Health and personal care" },
  { name: "Solkrem", category: "Health and personal care" },
  { name: "Solkrem barn", category: "Health and personal care" },
  { name: "Myggspray", category: "Health and personal care" },
  { name: "Bandasje", category: "Health and personal care" },
  { name: "Sårsalve", category: "Health and personal care" },
  { name: "Antibac", category: "Health and personal care" },
  { name: "Munnbind", category: "Health and personal care" },
  { name: "Paracet", category: "Health and personal care" },
  { name: "Ibux", category: "Health and personal care" },
  { name: "Paracetamol barn", category: "Health and personal care" },
  { name: "Nesespray", category: "Health and personal care" },
  { name: "Halstabletter", category: "Health and personal care" },
  { name: "Hostesaft", category: "Health and personal care" },
  { name: "Termometer", category: "Health and personal care" },
  { name: "Bomullspinner", category: "Health and personal care" },
  { name: "Tannbørste barn", category: "Health and personal care" },
  { name: "Tannkrem barn", category: "Health and personal care" },
  { name: "Tanntråd", category: "Health and personal care" },
  { name: "Munnskyll", category: "Health and personal care" },
  { name: "Sjampo barn", category: "Health and personal care" },
  { name: "Balsam", category: "Health and personal care" },
  { name: "Deodorant", category: "Health and personal care" },
  { name: "Barberskum", category: "Health and personal care" },
  { name: "Barberblader", category: "Health and personal care" },
  { name: "Bind", category: "Health and personal care" },
  { name: "Tamponger", category: "Health and personal care" },
  { name: "Truseinnlegg", category: "Health and personal care" },
  { name: "Fuktighetskrem", category: "Health and personal care" },
  { name: "Q-tips", category: "Health and personal care" },
  { name: "Vitaminer", category: "Health and personal care" },
  { name: "Tran", category: "Health and personal care" },
  { name: "Multivitamin barn", category: "Health and personal care" },
  { name: "Kattemat våt", category: "Pet supplies" },
  { name: "Kattemat tørr", category: "Pet supplies" },
  { name: "Kattesand", category: "Pet supplies" },
  { name: "Kattegodteri", category: "Pet supplies" },
  { name: "Hundemat våt", category: "Pet supplies" },
  { name: "Hundemat tørr", category: "Pet supplies" },
  { name: "Hundegodteri", category: "Pet supplies" },
  { name: "Tyggebein", category: "Pet supplies" },
  { name: "Fuglefrø", category: "Pet supplies" },
  { name: "Fiskefôr", category: "Pet supplies" },
  { name: "Kaninmat", category: "Pet supplies" },
  { name: "Dyreleker", category: "Pet supplies" },
  { name: "Bæsjeposer hund", category: "Pet supplies" },
  { name: "Gavepapir", category: "Other" },
  { name: "Gavebånd", category: "Other" },
  { name: "Bursdagslys", category: "Other" },
  { name: "Ballonger", category: "Other" },
  { name: "Servietter fest", category: "Other" },
  { name: "Engangsbestikk", category: "Other" },
  { name: "Engangstallerken", category: "Other" },
  { name: "Plastkopper", category: "Other" },
  { name: "Sugerør", category: "Other" },
  { name: "Grillkull", category: "Other" },
  { name: "Tennvæske", category: "Other" },
  { name: "Potteplante", category: "Other" },
  { name: "Jord", category: "Other" },
  { name: "Frø", category: "Other" },
  { name: "Kirsebær", category: "Fruit and vegetables" },
  { name: "Søtkirsebær", category: "Fruit and vegetables" },
  { name: "Stikkelsbær", category: "Fruit and vegetables" },
  { name: "Tranebær", category: "Fruit and vegetables" },
  { name: "Fiken", category: "Fruit and vegetables" },
  { name: "Dadler", category: "Fruit and vegetables" },
  { name: "Litchi", category: "Fruit and vegetables" },
  { name: "Papaya", category: "Fruit and vegetables" },
  { name: "Physalis", category: "Fruit and vegetables" },
  { name: "Mirabelle", category: "Fruit and vegetables" },
  { name: "Kaki", category: "Fruit and vegetables" },
  { name: "Fennikel", category: "Fruit and vegetables" },
  { name: "Artisjokk", category: "Fruit and vegetables" },
  { name: "Pak choi", category: "Fruit and vegetables" },
  { name: "Mangold", category: "Fruit and vegetables" },
  { name: "Friséesalat", category: "Fruit and vegetables" },
  { name: "Romansalat", category: "Fruit and vegetables" },
  { name: "Vårsalat", category: "Fruit and vegetables" },
  { name: "Selleriknoll", category: "Fruit and vegetables" },
  { name: "Nepe", category: "Fruit and vegetables" },
  { name: "Estragon", category: "Fruit and vegetables" },
  { name: "Salvie", category: "Fruit and vegetables" },
  { name: "Karse", category: "Fruit and vegetables" },
  { name: "Sjalottløk", category: "Fruit and vegetables" },
  { name: "Rugbrød", category: "Bread and bakery" },
  { name: "Flatbrød", category: "Bread and bakery" },
  { name: "Lompe", category: "Bread and bakery" },
  { name: "Grissini", category: "Bread and bakery" },
  { name: "Bagel", category: "Bread and bakery" },
  { name: "Müslibrød", category: "Bread and bakery" },
  { name: "Solsikkebrød", category: "Bread and bakery" },
  { name: "Steinbakt brød", category: "Bread and bakery" },
  { name: "Lavkarbobrød", category: "Bread and bakery" },
  { name: "Glutenfritt brød", category: "Bread and bakery" },
  { name: "Wienerbrød", category: "Bread and bakery" },
  { name: "Mascarpone", category: "Dairy" },
  { name: "Ricotta", category: "Dairy" },
  { name: "Halloumi", category: "Dairy" },
  { name: "Geitost", category: "Dairy" },
  { name: "Pultost", category: "Dairy" },
  { name: "Havremelk", category: "Dairy" },
  { name: "Mandelmelk", category: "Dairy" },
  { name: "Soyamelk", category: "Dairy" },
  { name: "Vegansk ost", category: "Dairy" },
  { name: "Vegansk yoghurt", category: "Dairy" },
  { name: "Vegansk rømme", category: "Dairy" },
  { name: "Kalvekjøtt", category: "Meat and fish" },
  { name: "Elgkjøtt", category: "Meat and fish" },
  { name: "Reinsdyrkjøtt", category: "Meat and fish" },
  { name: "Andebryst", category: "Meat and fish" },
  { name: "Kanin", category: "Meat and fish" },
  { name: "Geitekjøtt", category: "Meat and fish" },
  { name: "Lammekoteletter", category: "Meat and fish" },
  { name: "Chorizo", category: "Meat and fish" },
  { name: "Pepperoni", category: "Meat and fish" },
  { name: "Prosciutto", category: "Meat and fish" },
  { name: "Parmaskinke", category: "Meat and fish" },
  { name: "Kyllingpålegg", category: "Meat and fish" },
  { name: "Kalkunpålegg", category: "Meat and fish" },
  { name: "Makrell i tomat", category: "Meat and fish" },
  { name: "Ansjos", category: "Meat and fish" },
  { name: "Kaviar", category: "Meat and fish" },
  { name: "Krabbeklør", category: "Meat and fish" },
  { name: "Hummer", category: "Meat and fish" },
  { name: "Østers", category: "Meat and fish" },
  { name: "Pangasius", category: "Meat and fish" },
  { name: "Steinbit", category: "Meat and fish" },
  { name: "Breiflabb", category: "Meat and fish" },
  { name: "Tofu", category: "Meat and fish" },
  { name: "Tempeh", category: "Meat and fish" },
  { name: "Vegankjøttdeig", category: "Meat and fish" },
  { name: "Falafel", category: "Meat and fish" },
  { name: "Cayennepepper", category: "Ingredients and spices" },
  { name: "Chiliflak", category: "Ingredients and spices" },
  { name: "Sambal Oelek", category: "Ingredients and spices" },
  { name: "Sweet chili saus", category: "Ingredients and spices" },
  { name: "BBQ saus", category: "Ingredients and spices" },
  { name: "Pesto", category: "Ingredients and spices" },
  { name: "Worcestershiresaus", category: "Ingredients and spices" },
  { name: "Fiskesaus", category: "Ingredients and spices" },
  { name: "Østerssaus", category: "Ingredients and spices" },
  { name: "Hoisinsaus", category: "Ingredients and spices" },
  { name: "Sriracha", category: "Ingredients and spices" },
  { name: "Tabasco", category: "Ingredients and spices" },
  { name: "Vaniljestang", category: "Ingredients and spices" },
  { name: "Safran", category: "Ingredients and spices" },
  { name: "Anis", category: "Ingredients and spices" },
  { name: "Fennikelfrø", category: "Ingredients and spices" },
  { name: "Korianderfrø", category: "Ingredients and spices" },
  { name: "Sennepsfrø", category: "Ingredients and spices" },
  { name: "Karvefrø", category: "Ingredients and spices" },
  { name: "Stjerneanis", category: "Ingredients and spices" },
  { name: "Nellik", category: "Ingredients and spices" },
  { name: "Hvit pepper", category: "Ingredients and spices" },
  { name: "Rødvinseddik", category: "Ingredients and spices" },
  { name: "Hvitvinseddik", category: "Ingredients and spices" },
  { name: "Kokosolje", category: "Ingredients and spices" },
  { name: "Sesamolje", category: "Ingredients and spices" },
  { name: "Agavesirup", category: "Ingredients and spices" },
  { name: "Lønnesirup", category: "Ingredients and spices" },
  { name: "Stevia", category: "Ingredients and spices" },
  { name: "Mandelmel", category: "Ingredients and spices" },
  { name: "Kokosmel", category: "Ingredients and spices" },
  { name: "Hampfrø", category: "Ingredients and spices" },
  { name: "Chiafrø", category: "Ingredients and spices" },
  { name: "Linfrø", category: "Ingredients and spices" },
  { name: "Peanøtter", category: "Ingredients and spices" },
  { name: "Pistasjnøtter", category: "Ingredients and spices" },
  { name: "Macadamianøtter", category: "Ingredients and spices" },
  { name: "Tørkede aprikoser", category: "Ingredients and spices" },
  { name: "Tørkede fiken", category: "Ingredients and spices" },
  { name: "Tørkede dadler", category: "Ingredients and spices" },
  { name: "Tørkede tranebær", category: "Ingredients and spices" },
  { name: "Is på pinne", category: "Frozen and ready meals" },
  { name: "Softis", category: "Frozen and ready meals" },
  { name: "Frosne bønner", category: "Frozen and ready meals" },
  { name: "Frossen blomkål", category: "Frozen and ready meals" },
  { name: "Frossen brokkoli", category: "Frozen and ready meals" },
  { name: "Iskake", category: "Frozen and ready meals" },
  { name: "Frosne croissanter", category: "Frozen and ready meals" },
  { name: "Frossen mango", category: "Frozen and ready meals" },
  { name: "Havremel", category: "Grains and pasta" },
  { name: "Bygg", category: "Grains and pasta" },
  { name: "Spelt", category: "Grains and pasta" },
  { name: "Rug", category: "Grains and pasta" },
  { name: "Müslibarer", category: "Grains and pasta" },
  { name: "Soyabønner", category: "Grains and pasta" },
  { name: "Edamame", category: "Grains and pasta" },
  { name: "Hirse", category: "Grains and pasta" },
  { name: "Risnudler", category: "Grains and pasta" },
  { name: "Eggnudler", category: "Grains and pasta" },
  { name: "Glassnudler", category: "Grains and pasta" },
  { name: "Udonnudler", category: "Grains and pasta" },
  ...
  { name: "Skumgodteri", category: "Snacks and sweets" },
  { name: "Marshmallows", category: "Snacks and sweets" },
  { name: "Lakrisrull", category: "Snacks and sweets" },
  { name: "Smågodt", category: "Snacks and sweets" },
  { name: "Proteinbar", category: "Snacks and sweets" },
  { name: "Sportsdrikk", category: "Drinks" },
  { name: "Kombucha", category: "Drinks" },
  { name: "Iskaffe", category: "Drinks" },
  { name: "Most", category: "Drinks" },
  { name: "Druejuice", category: "Drinks" },
  { name: "Tranebærjuice", category: "Drinks" },
  { name: "Ananasjuice", category: "Drinks" },
  { name: "Mangojuice", category: "Drinks" },
  { name: "Sider", category: "Drinks" },
  { name: "Alkoholfritt øl", category: "Drinks" },
  { name: "Matboks", category: "Household" },
  { name: "Termos", category: "Household" },
  { name: "Drikkeflaske", category: "Household" },
  { name: "Avkalkningsmiddel", category: "Household" },
  { name: "Finvask", category: "Household" },
  { name: "Silikonform", category: "Household" },
  { name: "Bakeform", category: "Household" },
  { name: "Engangshansker", category: "Household" },
  { name: "Gummihansker", category: "Household" },
  { name: "Kost", category: "Household" },
  { name: "Feiebrett", category: "Household" },
  { name: "Vindusvisker", category: "Household" },
  { name: "Toalettbørste", category: "Household" },
  { name: "Møllmiddel", category: "Household" },
  { name: "Insektspray", category: "Household" },
  { name: "Sikringer", category: "Household" },
  { name: "Forlengerledning", category: "Household" },
  { name: "Vitamin D", category: "Health and personal care" },
  { name: "Magnesium", category: "Health and personal care" },
  { name: "Probiotika", category: "Health and personal care" },
  { name: "Jerntilskudd", category: "Health and personal care" },
  { name: "Allergitabletter", category: "Health and personal care" },
  { name: "Øyedrops", category: "Health and personal care" },
  { name: "Nesedrops", category: "Health and personal care" },
  { name: "Kompresser", category: "Health and personal care" },
  { name: "Sportstape", category: "Health and personal care" },
  { name: "Kuldepose", category: "Health and personal care" },
  { name: "Varmepute", category: "Health and personal care" },
  { name: "Graviditetstest", category: "Health and personal care" },
  { name: "Kondomer", category: "Health and personal care" },
  { name: "Menstruasjonskopp", category: "Health and personal care" },
  { name: "Intimvask", category: "Health and personal care" },
  { name: "Rakekrem", category: "Health and personal care" },
  { name: "Hårfjerningskrem", category: "Health and personal care" },
  { name: "Hårspray", category: "Health and personal care" },
  { name: "Hårgele", category: "Health and personal care" },
  { name: "Leppepomade", category: "Health and personal care" },
  { name: "Negleklipper", category: "Health and personal care" },
  { name: "Pinsett", category: "Health and personal care" },
  { name: "Hamstermat", category: "Pet supplies" },
  { name: "Marsvinmat", category: "Pet supplies" },
  { name: "Lim", category: "Other" },
  { name: "Saks", category: "Other" },
  { name: "Penn", category: "Other" },
  { name: "Notatbok", category: "Other" },
  { name: "Konvolutter", category: "Other" },
  { name: "Gjødsel", category: "Other" }
];
