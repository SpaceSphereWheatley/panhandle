...
- **`public/`** — static assets Vite copies verbatim into `dist/`: `index.html` (unauthenticated marketing/landing page, links to `/app.html`), `changelog.html` (unauthenticated full-changelog page rendering `/CHANGELOG.md`, see Versioning), `manifest.json`, icons, `CHANGELOG.md`.
