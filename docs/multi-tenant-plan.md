...
- **No self-service signup**: by design (admin/owner gated creation), so this doesn't turn it into a public product — it stays invite-only, which matches what you described.
